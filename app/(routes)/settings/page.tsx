        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2 rounded-lg border border-border p-4 text-sm text-muted-foreground">
            ...
            <p>
              ...
              ：两处会离开我们数据库的数据流 ——
              ① 你上传的 syllabus 文本会发送给 AI 服务商（当前为 DeepSeek，服务器在中国境内）做解析；
              ② 课程更新对话框里粘贴的**截图**会发送给视觉模型服务商（通义千问 Qwen，阿里云中国区 DashScope）做识别。
              两类都在中国境内处理，**无数据出境**。截图识别是一次性输入、**不留存**；
              ⚠️ 截图可能含姓名 / 学号等个人信息，请避免包含（开放问题 O-08 已于 2026-09-13 解决：全中国境内部署）。
            </p>
            <p>
