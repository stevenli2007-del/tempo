...
/**
 * `PUT /api/v1/courses/:id/exam-dates（API-Contract.md 第 4 节，P0-1-5b）。
 *
 * 全量替换该课程的考试日期（保存后触发 exam → tasks 派生，ADR-004）板块，幂等。
...
export async function PUT(request: Request, { params }: RouteContext) {
  ...
  return handleSectionSave(request, id, 'exam-dates')
}
