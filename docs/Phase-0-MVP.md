...
- **🔴 待 Steven 手跑迁移**：`supabase/migrations/20260923000000_syllabus_drift.sql`（`courses` 加 `syllabus_file_id` / `syllabus_seen_modified_at` 两列，**只加两列、不动任何枚举、无需补 CHECK**）。**先跑 SQL 后部署**，否则 42703。

#### 🎫 P0-3-23 · practice test 生成（类型 A） 🟡 **代码完成，等 Steven 验收**
