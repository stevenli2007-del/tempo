...
**当前 task**：`P0-3-10` Canvas 提交状态同步 + 日期时区修复 ✅ **已完成（2026-09-13 用户验收）** —— 代码 `147aca0` + 实现记录 `04b3508` 已 push。后续可开：`P0-3-7`（已解闸）/ `P0-3-8`（可开）/ `P0-3-9`（仍依赖 O-11）。
...
| **P0-3-7** | **总览页可视化**：周历 / 时间线视图 + 考试日期并入主 Calendar + 进度条（**分子分母口径必须先定**） | Bud | —（已解闸：3-10 2026-09-13 完成） | 考试日期在日历可见；进度条口径明确且数据准确 | 🟢 已解闸 |
...
#### 🎫 P0-3-7 · 总览页可视化：周历 / 时间线 + 考试并入 + 进度条 🟢 **已解闸（3-10 2026-09-13 完成）**
