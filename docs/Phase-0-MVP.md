...
**当前 task**：`P0-3-10` Canvas 提交状态同步 + 日期时区修复 🔴 **地基卡，未开工**（依赖 P0-3-3 ✅ / P0-3-5 ✅ / P0-3-6 ✅ 已收）。
...
| **P0-3-10** | **Canvas 提交状态同步 + 日期时区修复**：`include[]=submission` + 三态 + 「待确认」态 + 按学校时区渲染 | Bud | — | 见下方执行卡 5 条验收路径 | ⚪ **地基卡** |
...
#### 🎫 P0-3-10 · Canvas 提交状态同步 + 日期时区修复 ⚪ **地基卡**
