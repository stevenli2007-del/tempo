...
| **P0-3-23** | **practice test 生成（类型 A 忠实自测）**：用户选 past exam + answer key → 抓内容 → **隐藏答案做自测卷**（可选「讲解解法」）→ 进消息栏 | Bud | P0-3-19、P0-3-27 | 生成自测卷；**不幻觉出新题**（类型 B 不做） | ⚪ |
