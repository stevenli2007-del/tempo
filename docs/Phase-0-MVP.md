...
**当前 task**：`P0-3-6` 总览页列表收敛 ⚪ **未开工**（领卡待定）。
上一张 `P0-3-5` 模块与上传解耦 ✅ **已验收 2026-09-13**（Steven 眼球验收 + Bud 本地 build 验证）。
...
| **P0-3-6** | **总览页列表收敛**：只列最近 10 条，其余收进 BOX | Bud | P0-3-3 | 与「已完成折叠」+ 7 天窗口语义不冲突 | ⚪ |
